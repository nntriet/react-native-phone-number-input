...
const isCountryPresent = (countries: { [key in CountryCode]: Country }) => (countryCode: CountryCode) =>
    !!countries[countryCode];

const isRegion = (region?: Region) => (country: Country) => (region ? country.region === region : true);
